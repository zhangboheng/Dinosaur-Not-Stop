...
export default class Settings {
  ...
  drawTabsContent() {
    ...
    if (this.selectedIndex === 0) {
      ...
      this.context.fillText('V 1.0.3', switchX + 26, textY);
      // 绘制圆角矩形背景
      ...
      const arr = ['版本 1.0.3', '增加游戏开篇画面和音效', '增加小恐龙闯关失败后的失败状态', '', '版本 1.0.2', '增加道具屋，通过看广告兑换道具', '', '版本 1.0.1', '关卡增加障碍物种类和黑夜变换', '增加历史成绩榜', '', '版本 1.0.0', 'Demo 版本发布'];
      const list = ['2024-01-30', '', '', '','2024-01-27', '', '', '2024-01-22', '', '', '', '2024-01-08', ''];
      // 计算文本高度和总内容高度
