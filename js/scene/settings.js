...
export default class Settings {
  ...
  drawTabsContent() {
    ...
    if (this.selectedIndex === 0) {
      ...
      const arr = ['版本 1.0.6', '降低难度，延长可玩性', '优化运行稳定性', '修复 bugs', '', '版本 1.0.5', '优化程序稳定性', '逃出监牢增加明显终点标识', '优化精简程序运行', '','版本 1.0.4', '修复PC端无法适配问题', '', '版本 1.0.3', '增加游戏开篇画面和音效', '增加小恐龙闯关失败后的失败状态', '', '版本 1.0.2', '增加道具屋，通过看广告兑换道具', '', '版本 1.0.1', '关卡增加障碍物种类和黑夜变换', '增加历史成绩榜', '', '版本 1.0.0', 'Demo 版本发布'];
      const list = ['2024-03-29', '', '', '', '','2024-03-18', '', '', '', '', '2024-03-15', '', '', '2024-01-30', '', '', '','2024-01-27', '', '', '2024-01-22', '', '', '', '2024-01-08', ''];
      // 计算文本高度和总内容高度
